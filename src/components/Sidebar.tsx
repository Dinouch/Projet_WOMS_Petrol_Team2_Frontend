  ...
  return (
    <div className="w-[220px] bg-white border-r border-gray-200 h-screen hidden md:flex flex-col transition-all duration-300 shadow-sm">
      ...
      <nav className="flex-1 p-4 space-y-2">
        <NavItem to="/costs" icon={<Home size={20} />} label="Accueil" isActive={location.pathname === '/costs'} />
        <NavItem to="/wells" icon={<BarChart3 size={20} />} label="Carte des puits" isActive={location.pathname === '/wells'} />
        <NavItem to="/" icon={<FileText size={20} />} label="Coûts" isActive={location.pathname === '/'} />
